            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white order-1">
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        {/* Email */}
                        <div>
                            <label htmlFor="login-email" className="block font-['Inter'] text-sm font-medium text-gray-700 mb-1">
                                Email Address
                            </label>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-1">
                                <label htmlFor="login-password" className="block font-['Inter'] text-sm font-medium text-gray-700">
                                    Password
                                </label>
