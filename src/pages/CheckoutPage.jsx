...
const CheckoutPage = () => {
    ...
    const shipping = cartTotal > 20000 ? 0 : (formData.deliveryMethod === 'express' ? 5000 : 2500);
    ...
    }, [handleFlutterPayment, formData, cartItems, subtotal, shipping, total, clearCart, navigate]);
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block font-['Inter'] text-sm font-medium text-gray-700 mb-1">Full Name</label>
                                    <input
                                        type="text"
                                        name="fullName"
                                ...
                                <div>
                                    <label className="block font-['Inter'] text-sm font-medium text-gray-700 mb-1">Email Address</label>
                                    <input
                                        type="email"
                                        name="email"
                                ...
                                <div>
                                    <label className="block font-['Inter'] text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                                    <div className="flex">
                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block font-['Inter'] text-sm font-medium text-gray-700 mb-1">Street Address</label>
                                    <input
                                        type="text"
                                        name="streetAddress"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block font-['Inter'] text-sm font-medium text-gray-700 mb-1">City</label>
                                        <input
                                            type="text"
                                            name="city"
                                            value={formData.city}
                                    ...
                                    <div>
                                        <label className="block font-['Inter'] text-sm font-medium text-gray-700 mb-1">State</label>
                                        <select
                                            name="state"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block font-['Inter'] text-sm font-medium text-gray-700 mb-1">LGA</label>
                                        <input
                                            type="text"
                                            name="lga"
                                            value={formData.lga}
                                    ...
                                    <div>
                                        <label className="block font-['Inter'] text-sm font-medium text-gray-700 mb-1">Postal Code</label>
                                        <input
                                            type="text"
                                            name="postalCode"
